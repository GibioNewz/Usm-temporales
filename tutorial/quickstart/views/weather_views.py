# quickstart/views/weather_views.py
"""
Weather-related views and API endpoints.
"""
...
__all__ = [
    'hello_world', 'weather_report', 'get_weather_data', 'get_weather_description',
    'uv_index', 'temperature', 'humidity', 'precipitation', 'wind_speed', 
    'visibility', 'cloud_cover', 'weather_summary'
]
